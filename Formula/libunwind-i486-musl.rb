class LibunwindI486Musl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=/opt/homebrew/bin/i486-linux-musl-gcc", "--host=i486-unknown-linux-musl", "--target=i486-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
