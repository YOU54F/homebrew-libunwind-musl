class LibunwindMipsMusl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=/opt/homebrew/bin/mips-linux-musl-gcc", "--host=mips-unknown-linux-musl", "--target=mips-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
    ...
    test do
      ...
      EOS
      system "mips-linux-musl-gcc", "-I#{include}", "test.c", "-L#{lib}", "-lunwind", "-o", "test"
      system "./test"
    end
  end