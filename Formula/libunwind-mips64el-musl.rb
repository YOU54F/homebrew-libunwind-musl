class LibunwindMips64elMusl < Formula
  ...
  def install
    system "./configure", *std_configure_args, "CC=mips64el-linux-musl-gcc", "--host=mips64el-unknown-linux-musl",
"--target=mips64el-unknown-linux-musl", "--disable-tests", "--disable-shared"
    system "make"
    system "make", "install"
  end
