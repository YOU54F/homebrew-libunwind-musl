class LibunwindArmMusl < Formula
  ...
  def install
    system "./configure", *std_configure_args, "CC=arm-linux-musleabi-gcc", "--host=armv7-unknown-linux-musleabi",
"--target=armv7-unknown-linux-musleabi", "--disable-tests", "--disable-shared"
    system "make"
    system "make", "install"
  end
