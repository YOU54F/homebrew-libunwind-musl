class LibunwindPowerpc64Musl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=powerpc64-linux-musl-gcc", "--host=powerpc64-unknown-linux-musl", "--target=powerpc64-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
