class LibunwindPowerpcSfMusl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=/opt/homebrew/bin/powerpc-sf-linux-musl-gcc", "--host=powerpc-sf-unknown-linux-musl", "--target=powerpc-sf-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
