class LibunwindI686Musl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=/opt/homebrew/bin/i686-linux-musl-gcc", "--host=i686-unknown-linux-musl", "--target=i686-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
