class LibunwindPowerpc64leMusl < Formula
    ...
    def install
      system "./configure", *std_configure_args,"CFLAGS=-fPIC -g -O2 -m64","CXXFLAGS=-g -O2 -m64","CC=/opt/homebrew/bin/powerpc64le-linux-musl-gcc", "--host=powerpc64le-unknown-linux-musl", "--target=powerpc64le-unknown-linux-musl","--disable-tests","--disable-shared","--disable-ptrace"
      system "make"
      system "make", "install"
    end
