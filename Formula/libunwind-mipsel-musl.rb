class LibunwindMipselMusl < Formula
  ...
  def install
    system "./configure", *std_configure_args, "CC=mipsel-linux-musl-gcc", "--host=mipsel-unknown-linux-musl",
"--target=mipsel-unknown-linux-musl", "--disable-tests", "--disable-shared"
    system "make"
    system "make", "install"
  end
  ...
  test do
    ...
    EOS
    system "mipsel-linux-musl-gcc", "-I#{include}", "test.c", "-L#{lib}", "-lunwind", "-o", "test"
    system "./test"
  end
end
