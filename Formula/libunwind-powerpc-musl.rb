class LibunwindPowerpcMusl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=/opt/homebrew/bin/powerpc-linux-musl-gcc", "--host=powerpc-unknown-linux-musl", "--target=powerpc-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
    ...
    test do
      ...
      EOS
      system "powerpc-linux-musl-gcc", "-I#{include}", "test.c", "-L#{lib}", "-lunwind", "-o", "test"
      system "./test"
    end
  end