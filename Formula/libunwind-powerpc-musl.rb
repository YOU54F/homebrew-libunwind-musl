class LibunwindPowerpcMusl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=powerpc-linux-musl-gcc", "--host=powerpc-unknown-linux-musl", "--target=powerpc-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
