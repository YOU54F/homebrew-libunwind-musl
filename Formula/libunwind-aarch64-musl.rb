class LibunwindAarch64Musl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=/opt/homebrew/bin/aarch64-linux-musl-gcc", "--host=aarch64-unknown-linux-musl", "--target=aarch64-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
