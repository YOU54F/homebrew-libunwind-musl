class LibunwindMips64Musl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=/opt/homebrew/bin/mips64-linux-musl-gcc", "--host=mips64-unknown-linux-musl", "--target=mips64-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
    ...
    test do
      ...
      EOS
      system "mips64-linux-musl-gcc", "-I#{include}", "test.c", "-L#{lib}", "-lunwind", "-o", "test"
      system "./test"
    end
  end