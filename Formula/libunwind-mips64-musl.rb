class LibunwindMips64Musl < Formula
    ...
    def install
      system "./configure", *std_configure_args, "CC=mips64-linux-musl-gcc", "--host=mips64-unknown-linux-musl", "--target=mips64-unknown-linux-musl","--disable-tests","--disable-shared"
      system "make"
      system "make", "install"
    end
