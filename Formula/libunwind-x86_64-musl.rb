class LibunwindX8664Musl < Formula
  ...
  def install
    system "./configure", *std_configure_args, "CC=x86_64-linux-musl-gcc", "--host=x86_64-unknown-linux-musl",
"--target=x86_64-unknown-linux-musl", "--disable-tests", "--disable-shared"
    system "make"
    system "make", "install"
  end
